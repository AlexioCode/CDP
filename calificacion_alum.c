...
do{
    ...
    switch(a){
        case 1: ver_nota(alum,materia,&nota,&N);
                break;
        case 2: mod_nota(alum, materia,&nota,&N);
                break;
        case 3: eliminar_nota(alum, materia,&nota,&N);
                break;
        case 4: aniadir_not(alum, materia,&nota,&N);
                break;
        case 5: return;
                break;
            }
