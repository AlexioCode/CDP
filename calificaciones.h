...
/*
cabecera: int borrar(int alum, int materia)
...
/*
cabecera: void ver_nota(int alum, int materia)
...
/*
cabecera: void mod_nota(int alum, int materia)
Precondicion: Le debe llegar la ID del alumno y de una materia
...
/*
cabecera: void eliminar_nota(int alum, int materia)
Precondicion: Le debe llegar la ID del alumno y de una materia
