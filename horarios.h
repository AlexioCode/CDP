...
*/
void modi_hora(int i,int *Y,materia *mater);
/*
...
*/
void grupo_hora(int i, int *A,r_alum *alum);
/*
...
/*
cabecera: void modificar_hora(int ID_pro, int *M, int *A, int *B, int *Y,horari *horarios,r_alum *alum,usuario *usuar,materia *mater)
...
*/
void modificar_hora(int ID_pro, int *M, int *A, int *B, int *Y,horari *horarios,r_alum *alum,usuario *usuar,materia *mater);
/*
...
/*
cabecera: void aniadir_hora(int ID_pro, int *B, int *A, int *M, int *Y,horari *horarios,r_alum *alum,usuario *usuar,materia *mater)
...
*/
void aniadir_hora(int ID_pro, int *B, int *A, int *M, int *Y,horari *horarios,r_alum *alum,usuario *usuar,materia *mater);
/*
...
*/
int busca(int ID_pro, int *M,usuario *usuar);
/*
cabecera: void admin_hora(int *A,int *B, int *Y, int *M,horari *horarios,r_alum *alum,usuario *usuar,materia *mater)
Postcondicion: Le abre el menu de horarios al admin y le manda a las respectivas funciones
*/
void admin_hora(int *A,int *B, int *Y, int *M,horari *horarios,r_alum *alum,usuario *usuar,materia *mater);
/*
